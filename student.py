...
class Student:
    def __init__(self,root):
        ...
        current_course_frame.place(x=5,y=20,width=720,height=110)
        ...
        search_combo['values']=("Search","Roll No","Phone No")
        ...
        table_frame.place(x=5,y=90,width=500,height=250)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                conn = mysql.connector.connect(host="localhost",username="root",password="2306",database="face_recognizer")
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                if Upadate>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="2306",database="face_recognizer")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Division=%s,Roll=%s,Gender=%s,DOB=%s,Email=%s,Phone=%s,Name=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
                        self.var_dep.get(),
                        self.var_course.get(),
                        self.var_year.get(),
                        self.var_semester.get(),
    ...
    def generate_dataset(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.va_std_id.get()=="":
            ...
            try:
                ...
                #load predefine data on face fontals from opencv
