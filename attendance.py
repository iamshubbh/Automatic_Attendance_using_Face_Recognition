...
class Attendance:
    def __init__(self,root):
        ...
        #img1
        img = Image.open(r"images\studying.png")
        ...
        #img2
        img1 = Image.open(r"images\studying2.png")
        ...
        self.atten_status=ttk.Combobox(left_inside_frame,state="readonly",textvariable=self.var_atten_attendance,font=("times new roman",12,"bold"))
        ...
        table_frame.place(x=1,y=10,width=640,height=384)
